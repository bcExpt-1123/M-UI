...
const Dashboard = ({
  pie, line, bar, labels, getBarData, getPieData, getLineData
}) => {
        ...
        >
          ...
          >
            <Box>
              <Card>
                <CardContent>
                  {values.chartType === 'bar' && <Bar chartData={bar} labels={labels} />}
                  {values.chartType === 'pie' && <Pie chartData={pie} labels={labels} />}
                  {values.chartType === 'line' && <Line chartData={line} labels={labels} />}
                </CardContent>
              </Card>
            </Box>
          </Grid>
